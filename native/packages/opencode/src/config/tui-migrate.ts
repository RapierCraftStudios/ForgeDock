...
const TUI_SCHEMA_URL = "https://forgedock.dev/tui.json"
...
/**
 * Migrates tui-specific keys (theme, keybinds, tui) from forgedock.json files
...
async function opencodeFiles(input: { directories: string[]; cwd: string }) {
  const files = [
    ...
    ...(await Filesystem.findUp(["forgedock.json", "forgedock.jsonc"], input.cwd, undefined, { rootFirst: true })),
  ]
