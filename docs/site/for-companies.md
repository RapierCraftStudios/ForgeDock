...
**To apply**: [Open a design-partner intake request](https://github.com/RapierCraftStudios/ForgeDock/issues/new?template=design-partner.yml) on GitHub, or email [licensing@rapiercraft.studio](mailto:licensing@rapiercraft.studio) directly.
